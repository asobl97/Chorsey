...
import MergeListContext from "@material-ui/core/ListItem/MergeListContext";
    ...
    <MergeListContext dense={denseProp} alignItems={alignItems}>
      {({ dense }) => {
        ...
        const hasSecondaryAction =
          children.length &&
          isMuiElement(children[children.length - 1], [
        ...
        if (hasSecondaryAction) {
          // Use div by default.
          Component =
            !componentProps.component && !componentProp ? "div" : Component;
